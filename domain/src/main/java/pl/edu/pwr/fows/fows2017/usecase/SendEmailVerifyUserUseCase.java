...
public class SendEmailVerifyUserUseCase extends AbstractRxObservableUseCase<Boolean> {

    private UserGateway gateway;


    public SendEmailVerifyUserUseCase(FowsRxTransformerProvider rxTransformer, UserGateway gateway) {
        super(rxTransformer);
    ...
    protected Observable<Boolean> createObservable() {
        return Observable.fromCallable(() -> gateway.sendEmailVerification());
    }
}
