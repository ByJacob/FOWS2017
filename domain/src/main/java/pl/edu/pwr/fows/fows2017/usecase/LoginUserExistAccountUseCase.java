...
public class LoginUserExistAccountUseCase extends AbstractRxObservableUseCase<Boolean> {

    private UserGateway gateway;

    public LoginUserExistAccountUseCase(FowsRxTransformerProvider rxTransformer, UserGateway gateway) {
        super(rxTransformer);
    ...
    protected Observable<Boolean> createObservable() {
        return Observable.fromCallable(() -> gateway.login());
    }
}
